...
#define CLK_SWR_HSI          ((uint8_t)0xE1) 
#define CLK_SWR_LSI          ((uint8_t)0xD2) 
#define CLK_SWR_HSE          ((uint8_t)0xB4) 
...
#define CLK_CKDIVR_HSIDIV1  (0x00<<3)
#define CLK_CKDIVR_HSIDIV2  (0x01<<3)
#define CLK_CKDIVR_HSIDIV4  (0x02<<3)
#define CLK_CKDIVR_HSIDIV8  (0x03<<3)
#define CLK_CKDIVR_CPUDIV1   0x00
#define CLK_CKDIVR_CPUDIV2   0x01
#define CLK_CKDIVR_CPUDIV4   0x02
#define CLK_CKDIVR_CPUDIV8   0x03
#define CLK_CKDIVR_CPUDIV16  0x04
#define CLK_CKDIVR_CPUDIV32  0x05
#define CLK_CKDIVR_CPUDIV64  0x06
#define CLK_CKDIVR_CPUDIV128 0x07
...
#define TIM1_CCMR_OCM_PWM2 ((uint8_t)0x70)
...
#define TIM2_CCMR_OCM_PWM1  ((uint8_t)0x60) /*!< Output Compare x Mode mask. */
